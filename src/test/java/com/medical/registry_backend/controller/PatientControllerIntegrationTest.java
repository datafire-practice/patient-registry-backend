...
//        // Выполняем запрос и выводим ответ для диагностики
//        MvcResult result = mockMvc.perform(post("/patient")
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .content(objectMapper.writeValueAsString(patient)))
//                .andDo(MockMvcResultHandlers.print()) // Выводим ответ в консоль
...
//        System.out.println("Create Patient Response: " + content);
//
//        // Десериализуем ответ в объект Patient
//        Patient savedPatient = objectMapper.readValue(content, Patient.class);
...
//        }
//        System.out.println("Saved Patient ID: " + samplePatientId);
//    }
//
//    @Test
...
//        }
//
//        MvcResult result = mockMvc.perform(get("/patient/" + samplePatientId)
//                        .contentType(MediaType.APPLICATION_JSON))
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.lastName").value("Генри"))
//                .andExpect(jsonPath("$.firstName").value("Ревирс"))
...
//                """;
//
//        MvcResult result = mockMvc.perform(put("/patient/" + samplePatientId)
//                        .contentType(MediaType.APPLICATION_JSON)
...
//        }
//
//        mockMvc.perform(delete("/patient/" + samplePatientId)
//                        .contentType(MediaType.APPLICATION_JSON))
...
//        mockMvc.perform(delete("/patient/999")
//                        .contentType(MediaType.APPLICATION_JSON))
//                .andExpect(status().isNotFound())
//                .andExpect(jsonPath("$.message").value("Пациент с ID 999 не найден"));
//    }
